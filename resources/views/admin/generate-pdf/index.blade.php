  ...
  <div class="card">
    ...
    <div class="card-content">
      ...
      <div class="info">
        ...
        <div>
          <p>{{ isset($item->title) ? $item->title : 'Tidak ada pengalaman' }}</p>
          <h6>{{ isset($item->position) ? $item->position : 'Tidak ada perusahaan' }}</h6>
          <p>{{ isset($item->description) ? $item->description : 'Tidak ada descriptions' }}</p>
        </div>
        @endforeach
        <div>
      </div>
